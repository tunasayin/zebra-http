                ...
                switch (_a.label) {
                    ...
                    case 6:
                        if (route === null || route === void 0 ? void 0 : route.getAvailableMethods().includes(req.method)) {
                            try {
                                if (this.debug)
                                    console.log("\u001B[32m[beaver-http]\u001B[0m: Recieved, a request executing route ".concat(route.path, "."));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.debug)
                            return [2];
                        console.log("\u001B[32m[beaver-http]\u001B[0m: \u001B[31mEncountered an error on ".concat(req.method, " ").concat(req.path, ", open route on browser to see information about the error.\u001B[0m"));
